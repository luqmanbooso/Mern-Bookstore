  ...
  return (
    ...
    <SideBar/>
      ...
      <div className="flex justify-center items-center gap-x-4">
        <button
          className="bg-sky-300 hover:bg-sky-800 hover:text-white px-4 py-1 rounded-lg hover:transition-all duration-200 ease-in-out"
        ...
        <button
          className="bg-sky-300 hover:bg-sky-800 hover:text-white px-4 py-1 rounded-lg"
